...
function FindData()
{
	...
	<body>
		<form  method="post" action="" >
		  <div class="modal fade custom-modal" id = "FindPopup" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
					...
					<div class="col-sm-12">
						<div class="cus-form-cont">
							<div class="col-sm-3 form-group">
								...
								<input type="text" id ="Text_FindUserName" name ="Text_FindUserName" value = "" class="form-control" oninput="this.value=this.value.toUpperCase()" placeholder="">
							</div>
							<div class="col-sm-3 form-group" id= "div1_for_useradmin">
								<label> First Name </label>
								<input type="text" id ="Text_FindFirstName" name ="Text_FindFirstName" value = "" class="form-control" placeholder="">
							</div>
							<div class="col-sm-3 form-group" id= "div2_for_useradmin">
								<label> Last Name </label>
								<input type="text" id ="Text_FindLastName" name ="Text_FindLastName" value = "" class="form-control" placeholder="">
							</div>					  
						  
							<div class="col-sm-3 form-group" id= "div1_for_accessmgmt">
								<label> Application Administrator </label>
								<select id ="Combo_FindAppAdmin" name ="Combo_FindAppAdmin" class="form-control" >
									<option value=''>- Application Administrator -</option>
									<option value='Yes'>Yes</option>
									<option value='No'>No</option>
								</select>
							</div>
							
							<div class="col-sm-3 form-group" id= "div1_for_assignappAdmin">
								<label> Application Name</label>
								<select id ="Combo_FindApplication" name ="Combo_FindApplication" class="form-control" >
									...
									<?php
										...
										while($row = mysql_fetch_array($result))
										{
											...
											echo "<option value='$ApplicationId'>$ApplicationName</option>";											
										}
									?>
							...
							<div class="col-sm-3 form-group" id= "div1_for_currentSubscriber">
								<label> Subscriber Name </label>
								<input type = "text" id = "Text_FindSubscriber" id = "Text_FindSubscriber" class="form-control">
							</div>
						</div>					
					</div>
				  ...
				  <div class="col-sm-12">
					<div class="cus-form-cont">					  
					  <div class="col-sm-3 form-group">
						...
						<input type="text" id ="DTPicker_FindStartDate" name ="DTPicker_FindStartDate" value = "" class="form-control" oninput="this.value=this.value.toUpperCase()" placeholder="">
					  </div>
					  <div class="col-sm-3 form-group">
						<label> End Date </label>
						<input type="text" id ="DTPicker_FindEndDate" name ="DTPicker_FindEndDate" value = "" class="form-control" oninput="this.value=this.value.toUpperCase()" placeholder="">
					  </div>
					  <div class="col-sm-3 form-group ">	
						<label> &nbsp;&nbsp; </label>
						<button type="button" id = "cmdFind" name = "cmdFind" class="btn btn-primary btn-style2 w100" onclick="FindData()" > <i class="fa fa-search" aria-hidden="true"></i> Find Users </button>
					  </div>
					</div>
