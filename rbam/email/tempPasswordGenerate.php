                    ...
                    <table class="" border="0" cellpadding="0" cellspacing="0" width="480">
                        <tbody><tr>
					       ...
					       <p style="font-size: 14px; line-height:20px; margin-top:0px; margin-bottom:2px; font-family: HelveticaNeue, sans-serif;" align="left">
							   <singleline label="Title">Hello, '.$user_email.'!</singleline>
						  </p>
                               <p style="font-size: 14px; line-height:20px; margin-top:0px; margin-bottom:2px; font-family: HelveticaNeue, sans-serif;" align="left">
							   <singleline label="Title">Your new temporary password has been generated as below.</singleline>
						  </p>
						  <p style="font-size: 14px; line-height:20px; margin-top:0px; margin-bottom:2px; font-family: HelveticaNeue, sans-serif;" align="left">
							   <singleline label="">'.$new_psw.'</singleline>
						  </p>
                                </td>
                            </tr>
